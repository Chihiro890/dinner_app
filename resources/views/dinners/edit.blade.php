    ...
    <div class="container lg:w-1/2 md:w-4/5 w-11/12 mx-auto mt-8 px-8 bg-white shadow-md">
        ...
        <form action="{{ route('dinners.update', $dinner) }}" method="POST" enctype="multipart/form-data"
            ...
            <select name="country">
                ...
                <option value="Aland Islands" {{ $dinner->country == "Aland Islands" ? 'selected' : '' }}>Aland Islands</option>
                ...
                <option value="American Samoa" {{ $dinner->country == "American Samoa" ? 'selected' : '' }}>American Samoa</option>
                ...
                <option value="Bouvet Island" {{ $dinner->country == "Bouvet Island" ? 'selected' : '' }}>Bouvet Island</option>
                <option value="Brazil" {{ $dinner->country == "Brazil" ? 'selected' : '' }}>Brazil</option>
                <option value="British Virgin Islands" {{ $dinner->country == "British Virgin Islands" ? 'selected' : '' }}>British Virgin Islands</option>
                ...
                <option value="Burkina Faso" {{ $dinner->country == "Burkina Faso" ? 'selected' : '' }}>Burkina Faso</option>
                ...
                <option value="Caicos Islands" {{ $dinner->country == "Caicos Islands" ? 'selected' : '' }}>Caicos Islands</option>
                ...
                <option value="Cayman Islands" {{ $dinner->country == "Cayman Islands" ? 'selected' : '' }}>Cayman Islands</option>
                <option value="Central African Republic" {{ $dinner->country == "Central African Republic" ? 'selected' : '' }}>Central African Republic</option>
                ...
                <option value="Christmas Island" {{ $dinner->country == "Christmas Island" ? 'selected' : '' }}>Christmas Island</option>
                <option value="Cocos Islands" {{ $dinner->country == "Cocos Islands" ? 'selected' : '' }}>Cocos Islands</option>
                ...
                <option value="Congo Brazzaville" {{ $dinner->country == "Congo Brazzaville" ? 'selected' : '' }}>Congo Brazzaville</option>
                <option value="Congo" {{ $dinner->country == "Congo" ? 'selected' : '' }}>Congo</option>
                <option value="Cook Islands" {{ $dinner->country == "Cook Islands" ? 'selected' : '' }}>Cook Islands</option>
                <option value="Costa Rica" {{ $dinner->country == "Costa Rica" ? 'selected' : '' }}>Costa Rica</option>
                <option value="Cote Divoire" {{ $dinner->country == "Cote Divoire" ? 'selected' : '' }}>Cote Divoire</option>
                ...
                <option value="Czech Republic" {{ $dinner->country == "Czech Republic" ? 'selected' : '' }}>Czech Republic</option>
                ...
                <option value="Dominican Republic" {{ $dinner->country == "Dominican Republic" ? 'selected' : '' }}>Dominican Republic</option>
                ...
                <option value="El Salvador" {{ $dinner->country == "El Salvador" ? 'selected' : '' }}>El Salvador</option>
                <option value="England" {{ $dinner->country == "England" ? 'selected' : '' }}>England</option>
                <option value="Equatorial Guinea" {{ $dinner->country == "Equatorial Guinea" ? 'selected' : '' }}>Equatorial Guinea</option>
                ...
                <option value="European Union" {{ $dinner->country == "European Union" ? 'selected' : '' }}>European Union</option>
                <option value="Falkland Islands" {{ $dinner->country == "Falkland Islands" ? 'selected' : '' }}>Falkland Islands</option>
                <option value="Faroe Islands" {{ $dinner->country == "Faroe Islands" ? 'selected' : '' }}>Faroe Islands</option>
                ...
                <option value="French Guiana" {{ $dinner->country == "French Guiana" ? 'selected' : '' }}>French Guiana</option>
                <option value="French Polynesia" {{ $dinner->country == "French Polynesia" ? 'selected' : '' }}>French Polynesia</option>
                <option value="French Territories" {{ $dinner->country == "French Territories" ? 'selected' : '' }}>French Territories</option>
                ...
                <option value="Guadeloupe" {{ $dinner->country == "Guadeloupe" ? 'selected' : '' }}>Guadeloupe</option>
                ...
                <option value="Guinea-Bissau" {{ $dinner->country == "Guinea-Bissau" ? 'selected' : '' }}>Guinea-Bissau</option>
                ...
                <option value="Heard Island" {{ $dinner->country == "Heard Island" ? 'selected' : '' }}>Heard Island</option>
                ...
                <option value="Indian Ocean Territory" {{ $dinner->country == "Indian Ocean Territory" ? 'selected' : '' }}>Indian Ocean Territory</option>
                ...
                <option value="Kazakhstan" {{ $dinner->country == "Kazakhstan" ? 'selected' : '' }}>Kazakhstan</option>
                ...
                <option value="Kyrgyzstan" {{ $dinner->country == "Kyrgyzstan" ? 'selected' : '' }}>Kyrgyzstan</option>
                ...
                <option value="Liechtenstein" {{ $dinner->country == "Liechtenstein" ? 'selected' : '' }}>Liechtenstein</option>
                <option value="Lithuania" {{ $dinner->country == "Lithuania" ? 'selected' : '' }}>Lithuania</option>
                <option value="Luxembourg" {{ $dinner->country == "Luxembourg" ? 'selected' : '' }}>Luxembourg</option>
                ...
                <option value="Madagascar" {{ $dinner->country == "Madagascar" ? 'selected' : '' }}>Madagascar</option>
                ...
                <option value="Marshall Islands" {{ $dinner->country == "Marshall Islands" ? 'selected' : '' }}>Marshall Islands</option>
                <option value="Martinique" {{ $dinner->country == "Martinique" ? 'selected' : '' }}>Martinique</option>
                <option value="Mauritania" {{ $dinner->country == "Mauritania" ? 'selected' : '' }}>Mauritania</option>
                ...
                <option value="Micronesia" {{ $dinner->country == "Micronesia" ? 'selected' : '' }}>Micronesia</option>
                ...
                <option value="Montenegro" {{ $dinner->country == "Montenegro" ? 'selected' : '' }}>Montenegro</option>
                <option value="Montserrat" {{ $dinner->country == "Montserrat" ? 'selected' : '' }}>Montserrat</option>
                <option value="Morocco" {{ $dinner->country == "Morocco" ? 'selected' : '' }}>Morocco</option>
                <option value="Mozambique" {{ $dinner->country == "Mozambique" ? 'selected' : '' }}>Mozambique</option>
                ...
                <option value="Netherlands Antilles" {{ $dinner->country == "Netherlands Antilles" ? 'selected' : '' }}>Netherlands Antilles</option>
                <option value="Netherlands" {{ $dinner->country == "Netherlands" ? 'selected' : '' }}>Netherlands</option>
                <option value="New Caledonia" {{ $dinner->country == "New Caledonia" ? 'selected' : '' }}>New Caledonia</option>
                <option value="New Guinea" {{ $dinner->country == "New Guinea" ? 'selected' : '' }}>New Guinea</option>
                <option value="New Zealand" {{ $dinner->country == "New Zealand" ? 'selected' : '' }}>New Zealand</option>
                ...
                <option value="Norfolk Island" {{ $dinner->country == "Norfolk Island" ? 'selected' : '' }}>Norfolk Island</option>
                <option value="North Korea" {{ $dinner->country == "North Korea" ? 'selected' : '' }}>North Korea</option>
                <option value="Northern Mariana Islands" {{ $dinner->country == "Northern Mariana Islands" ? 'selected' : '' }}>Northern Mariana Islands</option>
                ...
                <option value="Philippines" {{ $dinner->country == "Philippines" ? 'selected' : '' }}>Philippines</option>
                <option value="Pitcairn Islands" {{ $dinner->country == "Pitcairn Islands" ? 'selected' : '' }}>Pitcairn Islands</option>
                ...
                <option value="Puerto Rico" {{ $dinner->country == "Puerto Rico" ? 'selected' : '' }}>Puerto Rico</option>
                ...
                <option value="Saint Helena" {{ $dinner->country == "Saint Helena" ? 'selected' : '' }}>Saint Helena</option>
                <option value="Saint Kitts and Nevis" {{ $dinner->country == "Saint Kitts and Nevis" ? 'selected' : '' }}>Saint Kitts and Nevis</option>
                <option value="Saint Lucia" {{ $dinner->country == "Saint Lucia" ? 'selected' : '' }}>Saint Lucia</option>
                <option value="Saint Pierre" {{ $dinner->country == "Saint Pierre" ? 'selected' : '' }}>Saint Pierre</option>
                <option value="Saint Vincent" {{ $dinner->country == "Saint Vincent" ? 'selected' : '' }}>Saint Vincent</option>
                <option value="Samoa" {{ $dinner->country == "Samoa" ? 'selected' : '' }}>Samoa</option>
                <option value="San Marino" {{ $dinner->country == "San Marino" ? 'selected' : '' }}>San Marino</option>
                <option value="Sandwich Islands" {{ $dinner->country == "Sandwich Islands" ? 'selected' : '' }}>Sandwich Islands</option>
                <option value="Sao Tome" {{ $dinner->country == "Sao Tome" ? 'selected' : '' }}>Sao Tome</option>
                <option value="Saudi Arabia" {{ $dinner->country == "Saudi Arabia" ? 'selected' : '' }}>Saudi Arabia</option>
                ...
                <option value="Serbia" {{ $dinner->country == "Serbia" ? 'selected' : '' }}>Serbia</option>
                <option value="Seychelles" {{ $dinner->country == "Seychelles" ? 'selected' : '' }}>Seychelles</option>
                <option value="Sierra Leone" {{ $dinner->country == "Sierra Leone" ? 'selected' : '' }}>Sierra Leone</option>
                ...
                <option value="Solomon Islands" {{ $dinner->country == "Solomon Islands" ? 'selected' : '' }}>Solomon Islands</option>
                <option value="Somalia" {{ $dinner->country == "Somalia" ? 'selected' : '' }}>Somalia</option>
                <option value="South Africa" {{ $dinner->country == "South Africa" ? 'selected' : '' }}>South Africa</option>
                <option value="South Korea" {{ $dinner->country == "South Korea" ? 'selected' : '' }}>South Korea</option>
                ...
                <option value="Switzerland" {{ $dinner->country == "Switzerland" ? 'selected' : '' }}>Switzerland</option>
                ...
                <option value="Tajikistan" {{ $dinner->country == "Tajikistan" ? 'selected' : '' }}>Tajikistan</option>
                ...
                <option value="Timorleste" {{ $dinner->country == "Timorleste" ? 'selected' : '' }}>Timorleste</option>
                ...
                <option value="Turkmenistan" {{ $dinner->country == "Turkmenistan" ? 'selected' : '' }}>Turkmenistan</option>
                ...
                <option value="United Arab Emirates" {{ $dinner->country == "United Arab Emirates" ? 'selected' : '' }}>United Arab Emirates</option>
                <option value="United States" {{ $dinner->country == "United States" ? 'selected' : '' }}>United States</option>
                <option value="Uruguay" {{ $dinner->country == "Uruguay" ? 'selected' : '' }}>Uruguay</option>
                <option value="Us Minor Islands" {{ $dinner->country == "Us Minor Islands" ? 'selected' : '' }}>Us Minor Islands</option>
                <option value="Us Virgin Islands" {{ $dinner->country == "Us Virgin Islands" ? 'selected' : '' }}>Us Virgin Islands</option>
                <option value="Uzbekistan" {{ $dinner->country == "Uzbekistan" ? 'selected' : '' }}>Uzbekistan</option>
                <option value="Vanuatu" {{ $dinner->country == "Vanuatu" ? 'selected' : '' }}>Vanuatu</option>
                <option value="Vatican City" {{ $dinner->country == "Vatican City" ? 'selected' : '' }}>Vatican City</option>
                ...
                <option value="Wallis and Futuna" {{ $dinner->country == "Wallis and Futuna" ? 'selected' : '' }}>Wallis and Futuna</option>
                <option value="Western Sahara" {{ $dinner->country == "Western Sahara" ? 'selected' : '' }}>Western Sahara</option>
            ...
            <div class="checkbox">
                <label>
                    ...
                    <input type="checkbox"> Other
                                    <label class="block text-gray-20 text-sm mb-2" for="description">
                {{-- 言語記入欄 --}}
            {{-- </label>
